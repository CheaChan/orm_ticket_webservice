 ...
 <div class="container">
  ...
  <div class="col-md-10">
   <div class="card">
    ...
    <div class="card-body">
     <form action="{{ url('category/store') }}/{{ isset($object) ? $object->id : 0}}" method="POST" enctype='multipart/form-data'>
      {{csrf_field()}}
      ...
      <a class="btn btn-danger" role="button" href="{{url('category')}}">Back</a>
    </form>
    </div>
   </div>
  </div>
